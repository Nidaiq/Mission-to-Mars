...
for index in range(0,len(images), 2):
    image_url_hem_full = images[index]['href']
    #print(image_url_hem_full)
    image_url =f'https://marshemispheres.com/{image_url_hem_full}'
    #print(image_url)
    browser.visit(image_url)
    html = browser.html
    s = soup(html, "html.parser")
    full_image = url + s.find('div', class_='downloads').ul.li.a['href']
    title = s.find('h2').text
    hemisphere_image_urls.append({"image_url": full_image, "title":title})
...
#     #hemisphere_image_urls.append({"image_url": image_url_hem_full})
